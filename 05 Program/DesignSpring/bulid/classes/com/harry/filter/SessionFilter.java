...
@WebFilter(filterName = "sessionFilter", urlPatterns = { "/page/*" }, initParams = { @WebInitParam(name = "noNeedLogin", value = "page,page/,page/login,page/saveLogin") })
public class SessionFilter implements Filter {
    ...
    private String getGoPage(HttpServletRequest request, String requestURI) {
        String goPage = "";
        requestURI = requestURI.substring("/page".length());
